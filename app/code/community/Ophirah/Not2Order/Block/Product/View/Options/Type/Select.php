    ...
    extends Mage_Catalog_Block_Product_View_Options_Type_Select
{
    ...
    {
        if(Mage::getStoreConfig('qquoteadv_general/orderability_and_prices/enabled') == 0 || Mage::getStoreConfig('qquoteadv_general/orderability_and_prices/usetemplates') == 0):
